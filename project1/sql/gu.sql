...
(null,"aa",now(),"这个眼镜还不错，款式比较喜欢，戴上去也舒服，包装挺用心的",1),
...
(null,"aa",now(),"物流挺快的，前天晚上就到了，只不过我最近比较忙，加班比较晚，每次回去小区物业都关门了，今天早上特地去取得，去过之后发现包装挺好的，拆开眼镜就戴上了，一路上也没发现不舒服呢，就是有点好清楚的感觉，可能之前的眼镜片磨花了，这个镜片好干净，很喜欢，下次再来",1),
...
(null,"aa",now(),"本来还担心快放假了，到货比较晚呢，没想到昨天早上才下订单配镜，今天中午眼镜就完好无损到手。而且发的顺丰快递，想不到的神速!另外这副佐川藤井的眼镜架货真价实、材质优良、制作精美、设计高端大气，与描述完全相符;戴上后贴切舒适、清澈明亮，非常满意!还有客服服务耐心、细致、热情、周到、负责，还送了很适用的附件、小工具和精美礼品!很贴心，很满意，会再次过来的，是很满意的一次网购配镜过程。",1),
(null,"aa",now(),"这款圆框眼镜虽然比较常见，但是眼镜框架和腿中间那里有点设计感，感觉比较不一样，这种添加金属的设计比较吸引我。我是去眼镜店验光了再来网上配镜的，后来才发现原来也可以上门验光，以前从来没有听说过，早知道就预约了，比较省事。不过眼镜最后收到了，度数很准确，而且眼镜也很好看，不出意外。这个大红色的镜框也非常衬托肤色，很喜欢。",1),
...
(null,"aa",now(),"不错！看起来质量很好，戴起来也很舒适，品牌的东西值得信赖！",1),
(null,"aa",now(),"眼镜很喜欢，不错",1),
(null,"aa",now(),"眼镜包装很好，下次约上门呵呵呵",1),
(null,"aa",now(),"第三副了，性价比很高，戴着舒服，度数很准，款式好看，很喜欢",1),
(null,"aa",now(),"红色的眼镜太有个性了，好喜欢",1),
(null,"aa",now(),"红色没有我想象的艳丽，不夸张，很好看",1),
(null,"aa",now(),"镜架很轻，很软，但是去配眼镜是，老板说东西挺好，说是什么材料的，质量挺好。佩戴也很舒服！好评！",1),
...
(null,"aa",now(),"客服态度超级好，居然可以忍受我这种选择困难症户！哈哈哈眼镜收到超级喜欢哦，虽然朋友说还看不习惯，时间久了就行了！真的很不错",1),
(null,"aa",now(),"眼镜款式真的很好，由于红色眼镜不太适合我，沟通店家换了一个，商家很快给我换了，还赠送了小饰品。谢谢了
",1),
(null,"aa",now(),"颜色太艳了好像，可能我平时比较喜欢浅色，我妹妹帮我拍的，懒得换，感觉还行",1),
(null,"aa",now(),"包装很严实漂亮，发货速度也快。很轻，不压鼻子！办公室各种脸型，试戴都很搭配。几乎不挑脸型。",1),
(null,"aa",now(),"大红色挺喜欢，刚开始担心hold不住，不过还好，搭配好很有范",1),
